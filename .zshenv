# Shell settings
export PATH="$PATH:$HOME/go/bin/:$HOME/.bin:$HOME/.config/rofi/scripts:$HOME/.local/bin:/usr/local/bin:$HOME/.local/kitty.app/bin:$HOME/bin:/usr/local/go/bin:$HOME/bin/:/usr/local/opt/openvpn/sbin/"
...
# rust
RUSTC_WRAPPER="/Users/a.bulgakov/.cargo/bin/sccache"
